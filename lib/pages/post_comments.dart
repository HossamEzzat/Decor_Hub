import 'package:Decor_Hub/pages/replay_comment.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:timeago/timeago.dart' as timeago;

class Post_Comments extends StatefulWidget {
  Post_Comments({required this.document});
  final DocumentSnapshot<Object?> document;

  @override
  State<Post_Comments> createState() => _Post_CommentsState();
}

class _Post_CommentsState extends State<Post_Comments> {
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    .collection('comments')
                    .where('postuid', isEqualTo: widget.document.id)
                    .snapshots(),
